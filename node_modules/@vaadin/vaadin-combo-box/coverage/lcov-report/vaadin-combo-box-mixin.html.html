...
<html lang="en">
<head>
    <title>Code coverage report for vaadin-combo-box-mixin.html</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> vaadin-combo-box-mixin.html
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">98.05% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>252/257</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">91.03% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>203/223</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<a name='L857'></a><a href='#L857'>857</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3207x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">23958x</span>
<span class="cline-any cline-yes">23958x</span>
<span class="cline-any cline-yes">22488x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">23958x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1524x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2186x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3383x</span>
<span class="cline-any cline-yes">3317x</span>
<span class="cline-any cline-yes">22398x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7829x</span>
<span class="cline-any cline-yes">7769x</span>
<span class="cline-any cline-yes">7769x</span>
<span class="cline-any cline-yes">60x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
      this.addEventListener('focusout', e =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!this._closeOnBlurIsPrevented) {
          this.close();
        }
      });
&nbsp;
...
&nbsp;
      this.addEventListener('touchend', e =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!this._clearElement || <span class="branch-1 cbranch-no" title="branch not covered" >e.composedPath()[0] !== this._clearElement)</span> {
          return;
        }
&nbsp;
...
&nbsp;
    ...
    open() {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.disabled &amp;&amp; !this.readonly) {
        this.opened = true;
      }
    }
&nbsp;
...
&nbsp;
      if (this.opened) {
        ...
        if (!this.$.overlay.touchDevice) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.focused) {
            this.focus();
          }
        }
...
&nbsp;
      ...
      if (path.indexOf(this._clearElement) !== -1) {
        this._clear();
        this.focus();
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (path.indexOf(this.inputElement) !== -1) {
...
&nbsp;
        ...
        this._onEnter(e);
      } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this._isEventKey(e, 'esc')) {
        this._onEscape(e);
      }
    }
&nbsp;
...
&nbsp;
    _onArrowDown() {
      if (this.opened) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.$.overlay._items) {
...
&nbsp;
    _markAllSelectionRange() {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this._inputElementValue !== undefined) {
...
&nbsp;
    _onEscape(e) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.opened) {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.allowCustomValue) {
...
&nbsp;
    ...
    _inputValueChanged(e) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (e.composedPath().indexOf(this.inputElement) !== -1) {
...
&nbsp;
    _filterChanged(filter, itemValuePath, itemLabelPath) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (filter === undefined || itemValuePath === undefined || itemLabelPath === undefined) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.inputElement) {
...
&nbsp;
    _filteredItemsChanged(e, itemValuePath, itemLabelPath) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (e.path === 'filteredItems' || <span class="branch-1 cbranch-no" title="branch not covered" >e.path === 'filteredItems.splices')</span> {
...
&nbsp;
     ...
     */
    checkValidity() {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.inputElement.validate) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Jun 29 2018 10:21:46 GMT+0200 (CEST)
</div>
</div>
